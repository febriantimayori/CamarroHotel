...
<head>
  ...
  <title>CAMARRO HOTEL | DATA USERS</title>
                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <?php } else { ?>
                          <span class="badge bg-secondary">Resepsionis</span>
                        <?php } ?>
                      </td>
                      <td>
                        <a href="edit_users.php?id=<?php echo $d['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                        <a href="hapus_users.php?id=<?php echo $d['id']; ?>" class="btn btn-sm btn-danger">Hapus</a>
                      </td>
                    </tr>
                  <?php 
                } 
