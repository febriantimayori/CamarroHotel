            ...
            <div class="card-body">  
              <form method="post" action="update_kamar.php" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="<?php echo $data['tipe_kamar']; ?>" name="tipe_kamar" placeholder="Tipe Kamar">
                </div>
                <div class="form-group">
                  <label>Fasilitas Kamar</label>
                  <textarea name="fasilitas" class="form-control" rows="3"><?php echo $data['fasilitas'] ?></textarea>
                </div>
                <div class="form-group">
                  <label>Harga</label>
                  <input name="id_kamar" value="<?php echo $data['id_kamar']; ?>" hidden>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="qty" value="<?php echo $data['stock']; ?>" class="form-control" placeholder="Masukkan Stock Kamar">
                </div> 
                <div class="form-group">
                  <label>Foto Kamar</label>
                  <img class="d-block" src="gambar/<?php echo $data['foto']; ?>" width="300">
                  <input type="file" name="foto" class="form-control">
                </div> 
                <button type="submit" name="tambahkamar" class="btn btn-info">Update</button>
              </form>  
            </div>
          </div>
        </div>
