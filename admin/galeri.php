...
<head>
  ...
  <title>CAMARRO HOTEL | DATA FASILITAS HOTEL</title>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="edit_galeri.php?id_galeri=<?php echo $row['id_galeri']; ?>" class="btn btn-sm btn-warning">Edit</a>
                      <a href="hapus_galeri.php?id_galeri=<?php echo $row['id_galeri']; ?>" class="btn btn-sm btn-danger">Hapus</a>
                    </td>
                  </tr>
                  <?php $no++; } ?>
                </tbody>
